...
const About = () => {
  return (
    <div className='bg-slate-800 text-white px-6 md:px-[10em]   pb-4'>
      <h2 className='flex justify-center py-6 bg-gradient-to-r from-pink-300 via-slate-300 to-purple-500 bg-clip-text text-2xl tracking-tight text-transparent'>Technologies</h2>
